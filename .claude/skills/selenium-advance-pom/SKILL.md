---
name: selenium-advance-pom
description: Use when building, reviewing, or debugging a Selenium WebDriver + Java test automation framework. Advanced Selenium WebDriver framework with three Page Object Model patterns (Basic POM, Improved POM, Page Factory), retry mechanisms, Allure reporting, Excel data-driven testing, and Selenoid grid support.
---
...
_Source: [Selenium Advanced POM Framework](https://github.com/PramodDutta/ATB11xSeleniumAdvanceFramework) v1.0.0 by thetestingacademy (MIT), via qaskills.sh._
